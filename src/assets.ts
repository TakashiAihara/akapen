...
import keysJs from '../web/keys.js' with { type: 'file' };
import mermaidJs from '../node_modules/mermaid/dist/mermaid.min.js' with { type: 'file' };
...
export const ASSETS: Record<string, string> = {
  ...
  'app.js': appJs,
  'keys.js': keysJs,
  'vendor/mermaid.min.js': mermaidJs,
};
